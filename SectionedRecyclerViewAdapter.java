package com.mysafetravel.falck.widget;
...
import static com.mysafetravel.falck.widget.Section.State;
...
public class SectionedRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void addSectionAtTop(String tag, Section section) {
        LinkedHashMap<String, Section> newMap = (LinkedHashMap<String, Section>) this.sections.clone();
        this.sections.clear();
        this.sections.put(tag, section);
        this.sections.putAll(newMap);
        this.sectionViewTypeNumbers.put(tag, viewTypeCount);
        viewTypeCount += VIEW_TYPE_QTY;
    }
